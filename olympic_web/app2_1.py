...
st.sidebar.image('https://c.tenor.com/L9Vs9r6PtOgAAAAC/minka-madebyminka.gif')
...
if user_menu == 'Country-wise Analysis':
    ...
    country_df = helper.yearWiseMedal(df,selected_country)
    ...
    top10_df = helper.mostsuccessful(df,selected_country)
    st.table(top10_df)
...
# adding the dropDown
st.caption('DBDA2021-22-Group_ID : 27')
